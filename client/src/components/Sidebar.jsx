...
import { FileText, Hash, House, Scissors, SquarePen, Users, Image, LogOut } from 'lucide-react'; // ✅ added Image
...
const navItems = [
  ...
  { to: '/ai/remove-background', label: 'Remove Background', Icon: Image },
    ...
    >
      <div className="my-7 w-full">
        ...
        <div className="px-6 mt-5 text-sm text-gray-600 font-medium">
          {navItems.map(({ to, label, Icon }) => ( // ✅ fixed destructuring (Icon, not icon)
            <NavLink
              key={to}
              to={to}
              end={to === '/ai'}
